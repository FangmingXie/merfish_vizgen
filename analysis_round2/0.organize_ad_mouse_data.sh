...
#### customize these two variables according to your system
# datadir is the directory that hosts the MERFISH data from Vizgen
# outputdir is a directory you set for downstream analysis
