...
# Step 2. Clustering and low-dimensional embedding using UMAP on all cells.
# inputs: `processed_merfish_ad_mouse.hdf5`
# output: `clustering_embedding_....tsv.gz`
...
for samples in samples_list:
    ...
    input = '../data/summary_tables_admouse/processed_merfish_ad_mouse.hdf5'
    output = '../data/summary_tables_admouse/clustering_embedding_{}_{}.tsv.gz'.format(samples_shortname, today)
